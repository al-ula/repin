...
use crate::model::identity::EdgeId;
...
use crate::model::unresolved::UnresolvedKey;
...
impl IndexingCoordinator {
        ...
        while attempts < Self::MAX_COMMIT_ATTEMPTS {
            ...
            for claim in &facts.nodes {
                ...
                for unresolved in pending {
                    ...
                    promoted_edges.push(crate::model::edge::EdgeClaim {
                        edge,
                        owner: FactOwner::new(
    ...
    pub fn resolve_existing(
        ...
        for reference in unresolved {
            ...
            for target in candidates {
                ...
                promoted.push(crate::model::edge::EdgeClaim {
                    edge,
                    owner: FactOwner::new(
    ...
    where
        F: Fn(&crate::model::node::Node) -> Option<ArtifactClass>,
    {
        let view = store.read_view()?;
        let base_revision = view.revision()?;
