...
pub fn execute_daemon_run(runtime_dir: Option<PathBuf>) -> Result<(), String> {
...
pub fn execute_daemon_restart(runtime_dir: Option<&Path>, db_path: &Path) -> Result<(), String> {
    DaemonClient::restart_daemon(runtime_dir, db_path)?;
    Ok(())
}
