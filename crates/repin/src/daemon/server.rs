...
use crate::daemon::registry::ContextRegistry;
...
impl DaemonServer {
        ...
        loop {
            ...
            IpcRequest::Handshake {
                ...
                IpcRequest::InitializeProject {
                    ...
                    match crate::daemon::state::initialize_state(Path::new(project_root)) {
                ...
                IpcRequest::UninitializeProject { ref project_root } if negotiated => {
                    if bound_context.is_some() {
                        ...
                        match crate::daemon::state::uninitialize_state(&registry, Path::new(project_root)) {
    ...
    fn dispatch_project_request(
        ctx: &crate::daemon::context_handle::ProjectContext,
        req: IpcRequest,
    ) -> IpcResponse {
        ...
        match req {
            ...
            IpcRequest::Context {
                ...
                let budget =
                    budget_bytes.unwrap_or(repin_runtime::ContextBuilder::DEFAULT_BYTE_BUDGET);
